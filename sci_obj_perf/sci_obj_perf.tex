...
\begin{figure}[!hbt]
 \begin{center}
   \raisebox{4pt}{\includegraphics[width=0.7\linewidth]{figs/figure_nsac_lrp_sidebar1}}
...
\begin{figure}[!hbt]
 \begin{center}
   \raisebox{4pt}{\includegraphics[width=0.7\linewidth]{figs/figure_nsac_lrp_sidebar2}}
...
%Shown in the right panel of Figure~\ref{fig:qhatconstraint} are a set of scenarios considered by Renk in 
...
%This enhancement of $\hat{q}$ is shown in Figure~\ref{fig:qhatmap} (right panel)
...
%at $T_0 = 300$~MeV with the traversal of a 30~GeV
%parton (left) and at $T_{0}=390$~MeV with the traversal of a 200~GeV
%parton (right)~\cite{Muller:usersmeeting,Muller:2010pm}.  
...
%An example is shown in Figure~\ref{fig:psiprime_rhic_lhc},
